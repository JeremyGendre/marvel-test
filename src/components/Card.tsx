    ...
    return (
        <Link className="flex flex-col rounded border border-gray-600 group overflow-hidden" to={link}>
            <div className="overflow-hidden relative">
                <div className="w-full h-full absolute z-10 opacity-0 group-hover:opacity-100 transition duration-300 flex bg-[rgba(0,0,0,0.2)]"><div className="m-auto">See more</div></div>
